...
\begin{center}
\url{https://github.com/infolake/goe-framework/blob/main/GoE_Toolkit/Shared_Resources/notebooks/goe_computational_protocol_fermion_mass_quantization.ipynb}
\end{center}
...
\begin{center}
\textbf{GitHub Repository:} \url{https://github.com/infolake/goe-framework} \\
...
\item \textbf{Direct link:} \url{https://github.com/infolake/goe-framework/blob/main/GoE_Toolkit/Shared_Resources/notebooks/goe_computational_protocol_fermion_mass_quantization.ipynb}
\item \textbf{Open in Google Colab:} \url{https://colab.research.google.com/github/infolake/goe-framework/blob/main/GoE_Toolkit/Shared_Resources/notebooks/goe_computational_protocol_fermion_mass_quantization.ipynb}
\end{itemize}
